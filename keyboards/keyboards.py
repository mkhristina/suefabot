...
admin_btn = KeyboardButton(text=LEXICON_RU["admin_btn"])
# Создаем клавиатуру с выбором игры
select_game_kb_admin: ReplyKeyboardMarkup = ReplyKeyboardMarkup(
    keyboard=[[button_rsp, button_cube, button_book], [admin_btn]],
    resize_keyboard=True,
    one_time_keyboard=True,
)
